...
const projects: Project[] = [
  {
    ...
    image: '/drumAI.png',
    workflowImage:
      'https://embed.figma.com/board/KouIzsSKkXAtlWrBVWQG0a/Drum-AI?node-id=0-1&embed-host=share',
  ...
  },
  {
    title: 'Home Network',
    description:
      'Created a home network for my family using Ubuntu Server and other open-source tools. Established a remote connection for global access',
    longDescription:
  ...
  },
  {
    ...
    description:
      'A webscraper designed to compare FOX and CNN in their images and word counts. Developed for the UMD Digital Engagement Lab',
    longDescription:
      'This project is intended to further the research in the Digital Engagement Lab at UMD. The Digital Engagement Lab, run by Professor Ronald Yaros, aims to refine a research-based digital content structure model.',
  ...
  },
  {
    ...
    description:
      "A syllabus chatbot for 70 journalism students combines LLM&apos;s with sentiment analysis to address queries and guide those with negative emotions to UMD mental health resources.",
    longDescription:
                ...
                <div className={styles.techStack}>
                  {project.technologies.map((tech) => (
                    <motion.div
                      ...
                      data-tooltip-id={`tooltip-${tech}-${index}`} // Unique ID for each tooltip
                      data-tooltip-content={tech} // Content of the tooltip
                    >
                      <img
                        src={techIcons[tech]}
                        alt={tech}
                      ...
                      <Tooltip
                        ...
                        place="top" // Replaced 'place' with 'position'
                        variant="dark" // Replaced 'effect' with 'variant'
                        // You can customize additional props here
                      />
                    </motion.div>
                  ))}
                </div>
