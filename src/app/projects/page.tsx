...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A syllabus chatbot for 70 journalism students combines LLMs with sentiment analysis to address queries and guide those with negative emotions to UMD mental health resources.",
    longDescription: "The Sentimental Chatbot is for my Professor and his journalism class with around 70 students. He told me that he was getting a lot of questions that could be easily be answered by the syllabus. After hearing this, I realized that I could utilize the ChatGPT assistants API to create a syllabus chatbot for him. I provided the syllabus as context, and the assistants API utulizes RAG to find the answer to the query. To solve the issue of hallucinations, I employed heavy negative prompting to ensure the model only answers questions directly related to the syllabus or class. In the case that the query does not meet these parameters, the chatbot instructs the student to email the Professor.",
